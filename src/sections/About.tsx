    ...
    return (
        <section id="about" className="py-20 md:px-20 px-5 mt-16">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 mt-16">
                {/* Left side: Image (1/3 on large screens, full width on small and medium screens) */}
                <div className="w-full xl:w-1/3 flex justify-center order-1">
                    <div
                ...
                {/* Right side: Info (2/3 on large screens, full width on small and medium screens) */}
                <div className="w-full xl:w-2/3 flex flex-col gap-4 text-center lg:text-left order-2 md:order-2">
